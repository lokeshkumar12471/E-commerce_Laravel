            ...
            <div class="row d-flex align-items-center">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <p class="mb-0"><a href="#"><span class="icofont icofont-ui-home"></span> Home</a>
                            <span class="icofont icofont-thin-right"></span> <a href="#">Topwear</a> <span
                ...
                <div class="col-md-6">
                    <div class="shop-detail-left">
                        <div class="shop-detail-slider position-relative">
                            <div class="favourite-icon"> <a class="fav-btn" title data-placement="bottom"
                                    data-toggle="tooltip" href="#" data-original-title="59% OFF"><i
                                        class="icofont-ui-tag"></i></a>
                            </div>
                    ...
                    <div class="shop-detail-right">
                        <div class="border rounded shadow-sm bg-white p-4">
                            <div class="product-name">
                                <p class="text-danger text-uppercase mb-0"> <i class="icofont-sale-discount"></i> 50%
                                    Off</p>
                                <h2>Chikankari Flared Sleeves Pink Top</h2>
                                <span>Product code: <b>OSAHAN456</b> | <strong class="text-info">FREE Delivery</strong>
                            ...
                            <div class="ratings">
                                <div class="stars-rating"> <i class="icofont icofont-star active"></i>
                                    ...
                                    <span class="rating-links float-right"> <a href="#">1 Review(s)</a> <span
                                            class="separator"> </span> <a href="#det"><i
                                                class="icofont icofont-comment"></i> Add Your Review</a>
                                    </span>
                                </div>
                            </div>
                                ...
                                <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                                    ...
                                    <label class="btn btn-sm btn-outline-secondary">
                                        <input type="radio" name="options" id="option2"
                                            autocomplete="off">S</label>
                                    <label class="btn btn-sm btn-outline-secondary">
                                        <input type="radio" name="options" id="option3"
                                            autocomplete="off">M</label>
                                    <label class="btn btn-sm btn-outline-secondary">
                                        <input type="radio" name="options" id="option4"
                                            autocomplete="off">L</label>
                                    <label class="btn btn-sm btn-outline-secondary">
                                        <input type="radio" name="options" id="option5"
                                            autocomplete="off">XL</label>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="short-description border-bottom">
                                <h6 class="mb-3">
                                    ...
                                    <small class="float-right">Availability: <strong class="badge badge-danger">In
                                            Stock</strong></small>
                                </h6>
                                ...
                                <p>Vivamus adipiscing nisl ut dolor dignissim semper. Nulla luctus malesuada tincidunt.
                                    ...
                                    vulputate mollis eget non arcu. Aenean et <a class="font-weight-bold"
                                        href="#det">View More[...]</a></p>
                            </div>
                            <div class="product-cart-option">
                                <ul class="list-inline mb-0 mt-3">
                                    <li class="list-inline-item"><a href="wishlist.html"><i
                                                class="icofont icofont-heart"></i> <span>Add to Wishlist</span></a>
                                    </li>
                                    <li class="list-inline-item"><a href="#"><i
                                                class="icofont icofont-retweet"></i> <span>Add to Compare</span></a>
                                    </li>
                                    <li class="list-inline-item"><a href="#"><i
                                                class="icofont icofont-send-mail"></i> <span>Email to a
                                                Friend</span></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="card-body p-0 reviews-card">
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            <div class="mt-0 mb-1">
                                                <span class="h6 mr-2 font-weight-bold">Stave Martin</span> <span><i
                                                        class="icofont-ui-calendar"></i> Feb 12, 2018</span>
                                                <div class="stars-rating float-right"> <i
                                                        class="icofont icofont-star active"></i>
                                                    <i class="icofont icofont-star active"></i>
                                                    <i class="icofont icofont-star"></i>
                                                    <i class="icofont icofont-star"></i>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="mt-0 mb-1">
                                                <span class="h6 mr-2 font-weight-bold">Mark Smith</span> <span><i
                                                        class="icofont-ui-calendar"></i> Feb 12, 2018</span>
                                                <div class="stars-rating float-right"> <i
                                                        class="icofont icofont-star active"></i>
                                                    <i class="icofont icofont-star active"></i>
                                            ...
                                            <div class="media mt-4">
                                                ...
                                                <div class="media-body">
                                                    <div class="mt-0 mb-1">
                                                        <span class="h6 mr-2 font-weight-bold">Ryan Printz</span>
                                                        <span><i class="icofont-ui-calendar"></i> Feb 12, 2018</span>
                                                        <div class="stars-rating float-right"> <i
                                                                class="icofont icofont-star active"></i>
                                                            <i class="icofont icofont-star active"></i>
                                                            <i class="icofont icofont-star"></i>
                                    ...
                                    <div class="media mt-4">
                                        ...
                                        <div class="media-body">
                                            <div class="mt-0 mb-1">
                                                <span class="h6 mr-2 font-weight-bold">Stave Mark</span> <span><i
                                                        class="icofont-ui-calendar"></i> Feb 12, 2018</span>
                                                <div class="stars-rating float-right"> <i
                                                        class="icofont icofont-star active"></i>
                                                    <i class="icofont icofont-star active"></i>
    ...
    <div class="cart-sidebar">
        ...
        <div class="cart-sidebar-footer">
            ...
            <a href="checkout.html">
                <button class="btn btn-primary btn-lg btn-block text-left" type="button"><span class="float-left"><i
                            class="icofont icofont-cart"></i> Proceed to Checkout </span><span
