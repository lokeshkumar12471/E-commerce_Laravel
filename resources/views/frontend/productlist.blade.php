        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                                    ...
                                    <div id="collapseSort" class="collapse" aria-labelledby="headingOffer"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan114">Discount (High to
                                                    Low)
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                    ...
                                    <div id="collapsetwo" class="collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan116">Jackets <small
                                                        class="text-black-50">156</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan117">
                                                <label class="custom-control-label" for="osahan117">Blazers & Coats
                                                    <small class="text-black-50">120</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan118">
                                                <label class="custom-control-label" for="osahan118">Suits <small
                                                        class="text-black-50">130</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan119">
                                                <label class="custom-control-label" for="osahan119">Rain Jackets
                                                    <small class="text-black-50">120</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan110">
                                                <label class="custom-control-label" for="osahan110"> T-Shirts <small
                                                        class="text-black-50">111</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan1111">
                                                <label class="custom-control-label" for="osahan1111"> Casual Shirts
                                                    <small class="text-black-50">95</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan1122">
                                                <label class="custom-control-label" for="osahan1122"> Formal Shirts
                                                    <small class="text-black-50">50</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan1133">
                                                <label class="custom-control-label" for="osahan1133"> Sweatshirts
                                                    <small class="text-black-50">32</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan1144">
                                                <label class="custom-control-label" for="osahan1144"> Sweaters <small
                                                        class="text-black-50">156</small></label>
                                            </div>
                                    ...
                                    <div id="collapseOffer" class="collapse" aria-labelledby="headingOffer"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan1100">Any Price
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                    ...
                                    <div id="collapsetwo" class="collapse show" aria-labelledby="headingTwo"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan11q">Jackets <small
                                                        class="text-black-50">156</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11w">
                                                <label class="custom-control-label" for="osahan11w">Blazers & Coats
                                                    <small class="text-black-50">120</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11e">
                                                <label class="custom-control-label" for="osahan11e">Suits <small
                                                        class="text-black-50">130</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11r">
                                                <label class="custom-control-label" for="osahan11r">Rain Jackets
                                                    <small class="text-black-50">120</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11y">
                                                <label class="custom-control-label" for="osahan11y"> T-Shirts <small
                                                        class="text-black-50">111</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11u">
                                                <label class="custom-control-label" for="osahan11u"> Casual Shirts
                                                    <small class="text-black-50">95</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11i">
                                                <label class="custom-control-label" for="osahan11i"> Formal Shirts
                                                    <small class="text-black-50">50</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11p">
                                                <label class="custom-control-label" for="osahan11p"> Sweatshirts
                                                    <small class="text-black-50">32</small></label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11po">
                                                <label class="custom-control-label" for="osahan11po"> Sweaters <small
                                                        class="text-black-50">156</small></label>
                                            </div>
                                            <div class="mt-2"><a href="#" class="link">See all</a></div>
                                        </div>
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan11z">Brand 1 <small
                                                        class="text-black-50">230</small>
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11zz">
                                                <label class="custom-control-label" for="osahan11zz">Brand 2 <small
                                                        class="text-black-50">95</small>
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11zzz">
                                                <label class="custom-control-label" for="osahan11zzz">Brand 3 <small
                                                        class="text-black-50">35</small>
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11x">
                                                <label class="custom-control-label" for="osahan11x">Brand 4 <small
                                                        class="text-black-50">46</small>
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="osahan11xx">
                                                <label class="custom-control-label" for="osahan11xx">Brand 5 <small
                                                        class="text-black-50">20</small></label>
                                            </div>
                                            <div class="mt-2"><a href="#" class="link">See all</a></div>
                                        </div>
                                    ...
                                    <div id="collapseOffer" class="collapse" aria-labelledby="headingOffer"
                                        ...
                                        <div class="filters-card-body card-shop-filters">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="osahan11cc">Any Price
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                    ...
                    <img src="{{ asset('frontend/img/offer-2.png') }}"
                        class="w-100 bg-white rounded overflow-hidden position-relative shadow-sm d-none d-sm-none d-md-block"
                        alt="...">
                </div>
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <span>613</span><br /> --}}
                                            <select name="size" id="sizeSelect{{ $product->id }}">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <p class="mb-0 text-dark">{{ $product->price }}</p>
                                            <button class="btn btn-danger"
                                                onclick="addProduct('{{ $product->product_images }}', '{{ $product->productSubCategory->sub_category_name }}', {{ $product->price }}, {{ $product->id }})">Add
                                                to Cart</button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    function addProduct(prodimage, prodcat, prodprice, prodid) {
        var selectedSize = $('#sizeSelect' + prodid).val();
