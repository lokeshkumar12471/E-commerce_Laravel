            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto main-nav-left">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('productlist') }}">ProductList</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('productdetail') }}"> ProductDetail</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('profile') }}"> MyAccount</a>
                        </li>
                        <li class="nav-item">
